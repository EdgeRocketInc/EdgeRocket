...
NOTE: Use master-heroku branch!

Ruby version 
------------
Developed and tested with 2.1.2

System dependencies
---
Developed on Mac OS X, and deployed on Heroku. 
Using Postgre SQL 9.3
No other dependencies yet

How to start:
----
- go to https://github.com/admitriyev/EdgeRocket and make sure it’s available to you, copy the link to git clone
...
https://github.com/admitriyev/EdgeRocket/wiki
