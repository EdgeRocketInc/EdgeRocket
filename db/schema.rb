...
ActiveRecord::Schema.define(version: 20150312163221) do
  ...
  create_table "recommendations_emails", force: true do |t|
    t.integer  "user_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "ui_messages", force: true do |t|
    t.text     "message_body"
    t.datetime "created_at"
    t.datetime "updated_at"
  end
