insert into accounts(company_name,options,overview) 
	values('coljjhansen@hotmail.com', 
...
insert into users(email, first_name, last_name, account_id, encrypted_password) 
	values('coljjhansen@hotmail.com', 'Justyn', 'Hansen', CURRVAL('accounts_id_seq'), '$2a$10$Ojv2t2XzqyasDZN7Gahyye2HMRLeun3M2mO8qE32Djl6KGWHz2OGi');
	-- User entred
