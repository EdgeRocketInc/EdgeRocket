insert into accounts(company_name,options,overview) 
	values('stephanie@theloveyourjobproject.com', 
...
insert into users(email, first_name, last_name, account_id, encrypted_password) 
	values('stephanie@theloveyourjobproject.com', null, null, CURRVAL('accounts_id_seq'), '$2a$10$ii/dDmLiNPFA6EbB4x3Di.4YyCnlIvu1Sfd2fEVOvAAUPgmE67lU.');
	-- EdgeFr@@
